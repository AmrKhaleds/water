    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                @endif
                <div class="card-body">
                    <form method="post" action="{{ route('printing_models.store') }}" enctype="multipart/form-data" novalidate>
                        @csrf
                        <div class="row">
                            <div class="col-lg-6">
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" id=""
                                                value="{{ old('name') }}" required name="name" placeholder="@lang('back.name') @lang('back.printing_models')">
                                        </div>
                                    </div>
                                </div>
                                <div class="mt-5 mt-lg-4">
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="file" class="form-control" id=""
                                                value="{{ old('image') }}" required name="image">
                                        </div>
                                    </div>
                                </div>
                            </div>
