...
@section('title')
    @lang('back.create') @lang('back.transfer_store')
@endsection
@section('css')
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0">@lang('back.create') @lang('back.transfer_store')</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item active">@lang('back.create') @lang('back.transfer_store')</li>
                                        ...
                                        <div class="col-sm-8">
                                            <select name="user_id" class="form-control select2">
                                                ...
                                                @foreach($stores as $from_store)
                                                    <option value="{{$from_store->id}}">{{$from_store->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-8">
                                            <select name="status" class="form-control select2" required>
                                                <option value="" disabled selected>@lang('back.select_one')</option>
                                                <option value="pending">@lang('back.pending')</option>
                                                <option value="ordered">@lang('back.ordered')</option>
                                            </select>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-12">
                                <table class="table table-bordered table-hover" id="tab_logic">
                                    ...
                                    <tr id='addr0'>
                                        ...
                                        <td><input type="number" required name='price[]' placeholder='@lang('back.price')' class="form-control price" step="0.00" min="0"/></td>
                                ...
                                <table class="table table-bordered table-hover" id="tab_logic_total">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"><div class="input-group mb-2 mb-sm-0">
                                                <input type="number" name="tax" value="0" class="form-control" id="tax" placeholder="0">
                            ...
                            <div class="col-lg-12">
                                <div class="mt-5 mt-lg-4">
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-8">
                                            <textarea name="description" class="form-control" placeholder="@lang('back.description')" cols="30" rows="5">{{old('description')}}</textarea>
                                        </div>
                                    </div>
