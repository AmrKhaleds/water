            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">@lang('back.edit_receipt')</div>
                    </div>
                    @if(Session::has('msg'))
                    ...
                    <div class="card-body">
                        <form action="{{route('receipts.update',$cach->id)}}" method="post">
                            @method('PUT')
                            @csrf
                            <div class="row gutters">
                                        ...
                                        <div class="col-sm-8">
                                            <select name="recipient_to" data-live-search="true" required class="form-control form-control-lg selectpicker">
                                                ...
                                                @foreach($suppliers as $supplier)
                                                    <option value="{{$supplier->id}}" {{$cach->recipient_to == $supplier->id ? 'selected' : ''}}>{{$supplier->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-sm-8">
                                            <select name="from_account" data-live-search="true" required class="form-control form-control-lg selectpicker">
                                                ...
                                                @foreach($recipients as $recipient)
                                                    <option value="{{$recipient->id}}" {{$cach->from_account == $recipient->id ? 'selected' : ''}}>{{$recipient->account_name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
