...
@section('title')
    @lang('back.create_payment_method')
@endsection
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">@lang('back.create_payment_method')</div>
                    </div>
                    @if(Session::has('msg'))
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control form-control-lg"
                                                   name="name" placeholder="@lang('back.name_payment_method')" value="{{old('name')}}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-6 col-lg col-md-6 col-sm-6 col-12">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <textarea class="summernote" placeholder="@lang('back.description')" rows="3" name="description">{{old('description')}}</textarea>
                                        </div>
                                    </div>
                                </div>
