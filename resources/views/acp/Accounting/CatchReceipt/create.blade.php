                            ...
                            <div class="row gutters">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="number" class="form-control form-control-lg"
                                                   ...
                                                   value="{{$last ? $last->bond_no + 1 : account_setting('accounting','sales','serial_catch_receipt')['value']}}" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-6 col-lg col-md-6 col-sm-6 col-12">
                                ...
                                <div class="col-xl-6 col-lg col-md-6 col-sm-6 col-12">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <select name="recipient_from" id="" required
                                                    class="form-control form-control-lg selectpicker"
                                                    data-live-search="true">
                                                <option value="">@lang('back.select_one')</option>
                                                @foreach($accounts as $client)
                                                    <option value="{{$client->id}}">{{$client->account_name}}
                                                        , {{$client->num}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                ...
                                <div class="col-xl-6 col-lg col-md-6 col-sm-6 col-12">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <select name="to_account" id="" required
                                                    class="form-control form-control-lg selectpicker"
                                                    data-live-search="true">
                                                <option value="">@lang('back.select_one')</option>
                                                @foreach($accounts as $recipient)
                                                    <option value="{{$recipient->id}}">{{$recipient->account_name}}, {{$recipient->num}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
