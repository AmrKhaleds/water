...
@section('title')
    @lang('back.create') @lang('back.booking')
@endsection
@section('css')
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0">@lang('back.create') @lang('back.booking')</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item active">@lang('back.create') @lang('back.booking')</li>
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-sm-8">
                                                <select name="bill_id" class="form-control select2">
                                                    ...
                                                    <option {{old('bill_id') == $bill->id ? 'selected' : ''}}  value="{{$bill->id}}">{{$bill->ref}}</option>
                                                    @endforeach
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="number" class="form-control"
                                                   value="{{old('filling_period')}}" required
                                    ...
                                    --}}<div class="row mb-4">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="date" class="form-control"
                                                   value="{{old('first_day_packing')}}" required
                                       ...
                                       {{-- <div class="row mb-4">
                                            ...
                                            <div class="col-sm-8">
                                                <select name="type" class="form-control">
                                                    <option value="">@lang('back.select_one')</option>
                                                    <option {{old('type') == 'new' ? 'selected' : ''}} value="new">@lang('back.new')</option>
                                                    <option {{old('type') == 'custody' ? 'selected' : ''}} value="custody">@lang('back.custody')</option>
                                                </select>
                                            </div>
                                        </div>--}}
                                        <div class="row mb-4">
                                            ...
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" name="from_address" class="form-control"
                                                           value="{{old('from_address')}}" required
                                            ...
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-sm-8">
                                                    <select name="status" class="form-control" required>
                                                        <option value="">@lang('back.select_one')</option>
                                                        <option value="sure">@lang('back.sure')</option>
                                                        <option value="waiting">@lang('back.waiting')</option>
                                                        <option value="reservation">@lang('back.reservation')</option>
                                                        <option value="canceled">@lang('back.canceled')</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
