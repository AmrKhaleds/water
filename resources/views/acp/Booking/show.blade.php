                ...
                <div class="card-body">
                    <div class="invoice-title">
                        <h4 class="float-end font-size-16">@lang('back.invoice')
                            #WF{{$booking->created_at->format('Ymdhi'.$booking->id)}}
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="text-muted">
                                ...
                                <h5 class="font-size-15 mb-2">{{$booking->bill->user->name}} : @lang('back.client_name')</h5>
                                <p class="mb-1">{{$booking->bill->user->profile->phone}} : @lang('back.client_phone')</p>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="text-muted text-sm-end">
                                <div>
                                    ...
                                    <p>#RF{{$booking->created_at->format('Ymdhi').$booking->id}}</p>
                                </div>
                                <div class="mt-4">
                        ...
                        <div class="row">
                                ...
                                <div class="text-muted">
                                    <div class="table-responsive mt-4">
                                        <div class="mt-4">
                                            ...
                                            <h5 class="font-size-16">{{$booking->area->name}}</h5>
                                        </div>
                                        <div class="mt-4">
                                            <p class="mb-1">@lang('back.near')</p>
                                            <h5 class="font-size-16">{{$booking->near}}</h5>
                                        </div>
                                        <div class="mt-4">
                                            <p class="mb-1">@lang('back.KM')</p>
                                            <h5 class="font-size-16">{{$booking->km}} @lang('back.KM')</h5>
                                        </div>
                                        <div class="mt-4">
                                            <p class="mb-1">@lang('back.vehicle_type')</p>
                                            <h5 class="font-size-16">@lang('back.'.$booking->vehicle_type)</h5>
                                        </div>
                                        ...
                                        <div class="mt-4">
                                            <p class="mb-1">@lang('back.own_key')</p>
                                            <span
                                                class="badge rounded-pill font-size-16 bg-{{$booking->own_key == 'on' ? 'success' : 'danger' }}">{{$booking->own_key == 'on' ? __('back.avalble') : __('back.unavalble') }}</span>
                                        </div>

                                        <div class="mt-4">
                                            <p class="mb-1">@lang('back.owner')</p>
                                            <span
                                                class="badge rounded-pill font-size-16 bg-{{$booking->owner == 'on' ? 'success' : 'danger' }}">{{$booking->owner == 'on' ? __('back.avalble') : __('back.unavalble') }}</span>
                                        </div>
                            ...
                            <div class="col-sm-5">
                                ...
                                <div class="text-muted">
                                    <div class="table-responsive mt-4">
                                        <div class="mt-4">
                                            <p class="mb-1">@lang('back.from_address')</p>
                                            <h5 class="font-size-16">{{$booking->from_address}}</h5>
                                        </div>
                                        <div class="mt-4">
                                            <p class="mb-1">@lang('back.gallon_type')</p>
                                            <h5 class="font-size-16">{{$booking->brand}}</h5>
                                        </div>
                                        <div class="mt-4">
                                        ...
                                        <div class="mt-4">
                                            <p class="mb-1">@lang('back.vehicle_status')</p>
                                            <h5 class="font-size-16">@lang('back.'.$booking->vehicle_status)</h5>
                                        </div>
                                        <div class="mt-4">
                                            <p class="mb-1">@lang('back.own_license')</p>
                                            <span
                                                class="badge rounded-pill font-size-16 bg-{{$booking->own_license == 'on' ? 'success' : 'danger' }}">{{$booking->own_license == 'on' ? __('back.avalble') : __('back.unavalble') }}</span>
                                        </div>
