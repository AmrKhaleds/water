        ...
        <div class="card-body">
            <div class="mb-3">
                <a href="{{route('bookings.create')}}" class="btn btn-primary waves-effect waves-light">
                    @lang('back.create') @lang('back.booking') <i class="uil uil-plus-square ms-2"></i>
                </a>
            ...
            <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap"
                ...
                <tr>
                    ...
                    <th>@lang('back.date') @lang('back.filling')</th>
...
{{--                        <td>@lang('back.'.$booking->gallon_type)</td>--}}
                        <td>{{$booking->brand}}</td>
                        <td>{{$booking->first_day_packing}}</td>
                        <td>{{$booking->area ? $booking->area->name : ''}}</td>
...
{{--                            <a href="https://wa.me/+2{{str_replace('-','',$booking->client->profile->whatsapp)}}?text=اهلا بك">--}}
                        ...
                        <td style="width: 100px">
                            ...
                            <a href="{{route('bookings.destroy',$booking->id)}}" class="btn btn-outline-danger btn-sm"
