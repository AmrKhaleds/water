...
@section('title')
    @lang('back.edit') @lang('back.vehicle')
@endsection
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0">@lang('back.edit') @lang('back.vehicle')</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item active">@lang('back.edit') @lang('back.vehicle')</li>
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-sm-8">
                                                <select name="type_car" class="form-control" required>
                                                    ...
                                                    <option {{$vehicle->type_car == 'freezer' ?  'selected' : ''}} value="crane">@lang('back.freezer')</option>
                                                </select>
                                            </div>
                                        </div>
