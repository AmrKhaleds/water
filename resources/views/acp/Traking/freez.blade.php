                        ...
                        <table class="table table-nowrap table-centered mb-0">
                            ...
                            @foreach($bookings->where('status','!=','canceled')->whereNull('vehicle_id') as $key => $booking)
                                <tr>
                                    ...
                                    <td>
                                                                                <a href="https://wa.me/+2{{Str::replace('-','',$booking->client->profile->whatsapp)}}?text=اهلا بك"
                                            <div class="avatar-sm">
                                                    <span
                                    ...
                                    <td>{{str_replace('-','',$booking->client->profile->phone)}}</td>
                                    ...
                                    <td>
                                        <select name="" class="form-control" onchange="location = this.value;">
                                            ...
                                            @foreach($vehicles->whereNotNull('assign_car_id')->where('status','available') as $keyCount => $vehicle)
                                                <option
                                                        value="{{route('booking.trakings.assign',[$booking->id,$vehicle->id])}}" {{$booking->vehicle_id==$vehicle->id ? 'selected' : ''}}>{{$vehicle->car_name}}
                                    ...
                                    <td style="width: 100px">
                                        ...
                                        <a href="{{route('booking.freezers.edit',$booking->id)}}"
                                           class="btn btn-outline-warning btn-sm"
                                           title="@lang('back.edit')"><i class="fas fa-pencil-alt"></i></a>
                                        <a href="{{route('booking.freezers.show',$booking->id)}}"
                                ...
                                <div id="myModal{{$booking->id}}" class="modal fade" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <form action="{{route('booking.trakings.destroy',$booking->id)}}" method="post">
                                            ...
                                            <table class="table table-nowrap table-centered mb-0">
                                                ...
                                                @foreach($car as $k => $value)
                                                    ...
                                                    <span
                                                        ...
                                                        <td>{{$value->FromArea ? $value->FromArea->name : ''}}</td>
                                                        <td>{{$value->ToArea ? $value->ToArea->name : ''}}</td>
                                                            ...
                                                            <div class="btn-group">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-end"
                                                                    ...
                                                                    <a class="dropdown-item text-primary"
                                                                       href="{{route('booking.trakings.status',[$value->id,'inprocess'])}}">
                                                                        <i class="fas fa-recycle"></i> @lang('back.inprocess')
                                                                    </a>
                                                                    <a class="dropdown-item text-info"
                                                                       href="{{route('booking.trakings.status',[$value->id,'inuploaded'])}}">
                                                                        <i class="fas fa-road"></i> @lang('back.inuploaded')
                                                                    </a>
                                                                    <a class="dropdown-item text-success"
                                                                       href="{{route('booking.trakings.status',[$value->id,'finished'])}}">
                                                                        <i class="fas fa-check-double"></i> @lang('back.finished')
                                                                    </a>
                                                                    <a class="dropdown-item text-warning"
                                                                       href="{{route('booking.trakings.undestroy',$value->id)}}">
                        ...
                        <table class="table table-nowrap table-centered mb-0">
                            ...
                            @foreach($bookings->where('status','canceled') as $key => $booking2)
                                <tr>
                                    ...
                                    {{--                                    <td>{{$booking2->client->name}}</td>--}}
                                    <td>
                                        <a href="https://wa.me/+2{{str_replace('-','',$booking2->client->profile->whatsapp)}}?text=اهلا بك" target="_blank">
                                    ...
                                    <td>{{str_replace('-','',$booking2->client->profile->phone)}}</td>
                                    ...
                                    <td style="width: 100px">
                                        <a href="{{route('booking.trakings.undestroy',$booking2->id)}}"
