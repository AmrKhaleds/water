                            ...
                            <div class="col-lg-6">
                                <div class="mt-5 mt-lg-4">
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-8">
                                            <select name="sallary_per" class="form-control" required>
                                                <option value="">@lang('back.select_one')</option>
                                                <option {{old('sallary_per') == 'in_hour' ? 'selected' : ''}} value="in_hour">@lang('back.in_hour')</option>
                                                <option {{old('sallary_per') == 'in_week' ? 'selected' : ''}} value="in_week">@lang('back.in_week')</option>
                                                <option {{old('sallary_per') == 'in_munoth' ? 'selected' : ''}} value="in_munoth">@lang('back.in_munoth')</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="row mb-4">
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="file" class="form-control" id="horizontal-Fullname-input"
                                                   required name="id[]" multiple accept="image/*" max="2" min="2">
