...
@section('title')
    @lang('back.create') @lang('back.store')
@endsection
@section('css')
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0">@lang('back.create') @lang('back.store')</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item active">@lang('back.create') @lang('back.store')</li>
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-8">
                                            <select name="type_store" class="form-control select2" required>
                                                ...
                                                <option value="fixed_store">@lang('back.fixed_store')</option>
