...
@section('title')
    @lang('back.edit') @lang('back.invoice') @lang('back.sudan_sales')
@endsection
@section('css')
    <style>
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0">@lang('back.edit') @lang('back.invoice') @lang('back.sudan_sales')</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item active">@lang('back.edit') @lang('back.sales')</li>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                @endif
                <div class="card-body">
                    <form method="post" action="{{ route('sudan_sales.update', $sale->id) }}" enctype="multipart/form-data"
                        novalidate>
                        @csrf
                        @method('PUT')
                        <div id="new_client-data" class="" style="">
                            ...
                            <div class="mt-5 mt-lg-4 row ms-2">
                                <div class="col-md-6 row mb-4">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" value="{{ $sale->client_name }}" required
                                ...
                                <div class="col-md-6 row mb-4">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="number" class="form-control phone_number"
                                            value="{{ $sale->client_phone }}" required placeholder="@lang('back.phone')"
                                            name="client_phone">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 row mb-4">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="number" class="form-control phone_number"
                                            value="{{ $sale->client_whatsapp }}" placeholder="@lang('back.whatsapp')"
                                ...
                                <div class="col-md-6 row mb-4">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="number" class="form-control" value="{{ $sale->client_passport }}"
                                ...
                                <div class="col-md-6 row mb-4">
                                    ...
                                    <div class="col-sm-8">
                                        <textarea class="form-control" placeholder="@lang('back.address')" name="address">{{ $sale->address }}</textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mt-5 mt-lg-4 row ms-2">
                                <div class="col-md-6 row mb-4">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" value="{{ $sale->driver_name }}"
                                ...
                                <div class="col-md-6 row mb-4">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="number" class="form-control phone_number"
                                            value="{{ $sale->driver_phone }}" placeholder="@lang('back.driver_phone')"
                                            name="driver_phone">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 row mb-4">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="number" class="form-control" value="{{ $sale->driver_passport }}"
                            ...
                            <div class="mt-5 mt-lg-4 row ms-2">
                                        ...
                                        <select name="product_id" class="form-control" required>
                                            ...
                                            @foreach ($products as $product)
                                                <option value="{{ $product->id }}"
                                                    @if ($sale->product_id == $product->id) selected @endif>{{ $product->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-6 row mb-4">
                                    ...
                                    <div class="col-sm-8">
                                        <select name="water_export" class="form-control">
                                            ...
                                            <option value="sudan" @if ($sale->water_export == 'sudan') selected @endif>
                                                @lang('back.sudan')</option>
                                            <option value="local" @if ($sale->water_export == 'local') selected @endif>
                                                @lang('back.local')</option>
                                            <option value="gaza" @if ($sale->water_export == 'gaza') selected @endif>
                                ...
                                <div class="col-md-4 row mb-4">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="number" class="form-control" value="{{ $sale->large_packages }}"
                                            placeholder="كمية الكراتين الكبيرة" name="large_packages">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 row mb-4">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="number" class="form-control" value="{{ $sale->small_packages }}"
                                            placeholder="كمية الكراتين الصغيرة" name="small_packages">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 row mb-4">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="number" class="form-control" id="purchase_price"
                                            value="{{ $sale->purchase_price }}" required
                                ...
                                <div class="col-md-6 row mb-4">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="number" class="form-control" id="sale_price"
                                            value="{{ $sale->sale_price }}" required placeholder="@lang('back.sale_price')"
                                            name="sale_price">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 row mb-4">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="number" class="form-control" id="expenses"
                                            value="{{ $sale->expenses }}" placeholder="@lang('back.expenses')"
                                            name="expenses">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 row mb-4">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="number" class="form-control" id="paper_loading_cost"
                                            value="{{ $sale->paper_loading_cost }}" placeholder="@lang('back.paper_loading_cost')"
                            ...
                            <div class="row mt-5 mt-lg-4 row ms-2">
                                <div class="col-md-6 row mb-4">
                                    <label class="col-sm-4 col-form-label">@lang('back.name')
                                        @lang('back.company') <span style="color: red;">*</span></label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" value="{{ $sale->company_name }}"
                                ...
                                <div class="col-md-6 row mb-4">
                                    ...
                                    <div class="col-sm-8">
                                        <select name="received" class="form-control" required>
                                            <option value="received" @if ($sale->received == 'received') selected @endif>
                                                @lang('back.is_received')
                                            </option>
                                            <option value="pending" @if ($sale->received == 'pending') selected @endif>
                                                @lang('back.pending')
                                            </option>
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-6 row mb-4">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control"
                                            value="{{ $sale->clearance_agent_name }}" placeholder="@lang('back.clearance_agent_name')"
                                ...
                                <div class="col-md-6 row mb-4">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="number" class="form-control phone_number"
                                            value="{{ $sale->clearance_agent_phone }}" placeholder="@lang('back.clearance_agent_phone')"
                                ...
                                <div class="col-md-6 row mb-4">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="datetime-local" name="goods_received_date" class="form-control"
                                            value="{{ $sale->goods_received_date }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-12">
                                <div class="mt-5 mt-lg-4">
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-8">
                                            <textarea name="notes" class="form-control" placeholder="@lang('back.description')" cols="30" rows="5">{{ $sale->notes }}</textarea>
                                        </div>
                                    </div>
