...
@section('title')
    @lang('back.edit') @lang('back.provider')
@endsection
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0">@lang('back.edit') @lang('back.provider')</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item active">@lang('back.edit') @lang('back.provider')</li>
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="number" class="form-control phone_number" id="horizontal-phone-input"
                                                   value="{{old('phone',$provider->profile ? $provider->profile->phone : '')}}" required
                                                ...
                                                @foreach($areas as $FromAreas)
                                                    <optgroup label="{{$FromAreas->name}}">
                                                        @foreach($FromAreas->children as $FromChildren)
                                                            <option {{$provider->profile->from_area == $FromChildren->id ? 'selected' : ''}}  value="{{$FromChildren->id}}">{{$FromChildren->name}}</option>
                                                        @endforeach
                                                    </optgroup>
                                                @endforeach
                                            </select>
                            ...
                            <div class="col-lg-6">
                                <div class="mt-5 mt-lg-4">
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="number" class="form-control phone_number" id="horizontal-phone-input"
                                                   value="{{old('whatsapp',$provider->profile ? $provider->profile->whatsapp : '')}}" required
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" id="horizontal-address-input"
                                                   value="{{old('address',$provider->profile ? $provider->profile->address : '')}}" required
